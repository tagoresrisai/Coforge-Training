...
public class ProductController {
	...
	@GetMapping("/product/{pid}/supplier")
	public ResponseEntity<?> FindEmployeeDetails(@PathVariable("pid") int pid) {

		ResponseEntity<ProductDto> responseEntity = null;
		ProductDto productDto = new ProductDto();
		Product product = service.findProduct(pid).get();
		
		SupplierDto supplier = service.getSupplierById(product.getSno());
